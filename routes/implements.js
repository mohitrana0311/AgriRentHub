...
router.route('/')
    ...
    .post(isLoggedIn, upload.array('image'), validateImplement, catchAsync(implements.createImplement))
...
router.route('/:id')
    ...
    .put(isLoggedIn, isAuthor, upload.array('image'), validateImplement, catchAsync(implements.updateImplement))
    .delete(isLoggedIn, isAuthor, catchAsync(implements.deleteImplement));

router.get('/:id/edit', isLoggedIn, isAuthor, catchAsync(implements.renderEditForm))
